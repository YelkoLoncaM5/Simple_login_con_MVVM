...
class LoginView: UIViewController {
    ...
    private lazy var loginButton: UIButton = {
        ...
        configuration.subtitle = "!Ingresa tus datos 📨!"
    ...
    private func startLogin(){
        loginViewModel.userLogin(
            withEmail: emailTextField.text?.lowercased() ?? "",
...
extension UITextField{
    ...
    var textPublisher: AnyPublisher<String, Never>{
        return NotificationCenter.default.publisher(for: UITextField.textDidChangeNotification, object: self).map{
            notification in
